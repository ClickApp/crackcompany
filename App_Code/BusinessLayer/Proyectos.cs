...
public class Proyectos
{
    ...
    public String anadirProyecto(string titulo, string subtitulo, int logo, string descripcion, string descripcionEng, int activo) 
    {
    ...
    public void actualizaProyecto(int proyectoId, string titulo, string subtitulo, int logo, string descripcion, string descripcionEng, int activo) 
    {
        SqlCommand cmd = new SqlCommand();
        SqlParameter sqlPar = null;
